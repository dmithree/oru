"""personal-context.json access — agent reads health/travel, writes briefing/carry_over.

fcntl-locked atomic read/write. Each agent writes only its own section.
"""
